<x-app-layout>
    <h1 class="text-4xl font-semibold text-center text-red-700 mt-20 mb-9">Editar Categoria</h1>
        ...
        <form action="{{ route('categories.update', ['category' => $category->id]) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea class="w-full h-32 px-4 p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-700" 
                          name="descricao" placeholder="Descrição">{{ old('descricao', $category->descricao) }}</textarea>
            </div>
