<x-app-layout>
    <div class="container mx-auto mt-8 max-w-md p-6 bg-black shadow-lg rounded-lg">
        ...
        <p class="text-white mb-6">Você tem certeza que deseja deletar o produto<strong> {{ $product->nome }}</strong>?</p>
        ...
        <form action="{{ route('products.destroy', ['product' => $product->id]) }}" method="POST">
            ...
            <div class="flex items-center justify-end">
                ...
                <a href="{{ route('products.index') }}" class="px-4 py-2 bg-gray-300 text-gray-700 font-semibold rounded-md hover:bg-gray-400 transition duration-200">
                    Voltar
                </a>
            </div>
        </form>
