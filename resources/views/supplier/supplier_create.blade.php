<x-app-layout>
    <h1 class="text-4xl font-semibold text-center text-red-700 mt-20 mb-9">Adicionar Fornecedor</h1>
    <div class="container mx-auto mt-6 max-w-2xl p-6 bg-black shadow-lg rounded-lg">
        ...
        <form action="{{ route('suppliers.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="telefone" name="telefone" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-700" placeholder="(00) 00000-0000" required />
            </div>
